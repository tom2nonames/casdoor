...
func GetOAuthCode(userId string, clientId string, responseType string, redirectUri string, scope string, state string, nonce string, challenge string, host string, lang string, SessionID string) (*Code, error) {
...
func GetOAuthToken(grantType string, clientId string, clientSecret string, code string, verifier string, scope string, username string, password string, host string, refreshToken string, tag string, avatar string, lang string, sessionID string) (interface{}, error) {
	application, err := GetApplicationByClientId(clientId)
	if err != nil {
		return nil, err
	}
	...
	case "password": //	Resource Owner Password Credentials Grant
		token, tokenError, err = GetPasswordToken(application, username, password, scope, host, sessionID)
...
func GetPasswordToken(application *Application, username string, password string, scope string, host string, sessionID string) (*Token, *TokenError, error) {
...
func GetClientCredentialsToken(application *Application, clientSecret string, scope string, host string, sessionID string) (*Token, *TokenError, error) {
	if application.ClientSecret != clientSecret {
		return nil, &TokenError{
			Error:            InvalidClient,
			ErrorDescription: "client_secret is invalid",
...
func GetWechatMiniProgramToken(application *Application, code string, host string, username string, avatar string, lang string, sessionID string) (*Token, *TokenError, error) {
